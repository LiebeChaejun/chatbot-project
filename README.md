...
**배포 링크에 접속하셨다면, 아래 시나리오를 순서대로 따라 해보시면 5분 안에 핵심 기능을 확인하실 수 있습니다.**
...
- **OpenAI GPT-4o-mini** — 의도 분류(temperature=0), 질문 재구성(temperature=0), 답변 생성(temperature=0.7) — 작업 성격에 따라 LLM 인스턴스 분리
